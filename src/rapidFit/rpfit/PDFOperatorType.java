...
public class PDFOperatorType {
    ...
    protected List<JAXBElement<?>> prodPDFOrNormalisedSumPDFOrPDF;
     ...
     * 
     */
    public List<JAXBElement<?>> getProdPDFOrNormalisedSumPDFOrPDF() {
        if (prodPDFOrNormalisedSumPDFOrPDF == null) {
            prodPDFOrNormalisedSumPDFOrPDF = new ArrayList<JAXBElement<?>>();
        }
